...
namespace Fusee.Tutorial.Core
{
    public class MeshExample : RenderCanvas
    {
                ...
                Children = new List<SceneNodeContainer>
                {
                    new SceneNodeContainer
                    {
                        Components = new List<SceneComponentContainer>
                        {
                            ...
                            {
                                Diffuse = new MatChannelContainer { Color = new float3(0.7f, 0.7f, 0f) },
                                Specular = new SpecularChannelContainer { Color = new float3(1, 0, 1), Shininess = 4 }
                            },
        ...
        public override void Init()
        {
            ...
            RC.ClearColor = new float4(0.2f, 0.3f, 0.9f, 1);
